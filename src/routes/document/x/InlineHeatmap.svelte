<script lang="ts">
	...
	let popoverWidth = 384; // Default width
	...
	function handleSegmentClick(event: MouseEvent, segment: any) {
		...
		const minWidth = 320; // Minimum width for readability
		const maxWidth = Math.min(800, viewportWidth - 40); // Max width with padding
